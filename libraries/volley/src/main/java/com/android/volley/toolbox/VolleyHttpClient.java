...
/**
 * Created by liuchao on 2015/11/13.
 */
public class VolleyHttpClient implements HttpClient {
     ...
     */
    public static VolleyHttpClient newInstance(String userAgent, Context context) {
        ...
        return new VolleyHttpClient(manager, params);
    }
     ...
     * with {@code field} set to {@code User-Agent}.
     */
    public static VolleyHttpClient newInstance(String userAgent) {
    ...
    private VolleyHttpClient(ClientConnectionManager ccm, HttpParams params) {
